 ...
 *     gcc SQLite_C_print_db.c sqlite-amalgamation/sqlite3.c
 *         -lpthread -ldl -lm -o db_print
 * 
 * Where:
 *  - sqlite3.c is the SQLite amalgamation source file; and
 *  - sqlite3.h is the header files that defines the C-language interfaces 
 *    to SQLite.
 *
...
#include <stdio.h>
/* Header file that accompanies sqlite3.c. 
